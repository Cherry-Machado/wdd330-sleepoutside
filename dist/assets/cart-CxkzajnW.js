import { l, g as n, p as s, s as d } from "./utils-D05f2JY9.js";
l();
function i(t) {
  const c = t.target.getAttribute("data-id");
  let e = n("so-cart");
  const a = e.findIndex((r) => r.Id === c);
  (e[a].quantity -= 1),
    e[a].quantity <= 0 && (e = e.filter((r) => r.Id !== c)),
    d("so-cart", e),
    o();
}
function o() {
  const t = n("so-cart"),
    c = t.map((a) => u(a)),
    e = s(t, (a) => a.FinalPrice * a.quantity);
  (document.querySelector(".cart-total__amount").textContent = e),
    (document.querySelector(".product-list").innerHTML = c.join("")),
    document.querySelectorAll(".cart-card__delete").forEach((a) => {
