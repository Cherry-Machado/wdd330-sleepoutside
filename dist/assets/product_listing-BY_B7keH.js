import { c as s, l as o, b as i } from "./utils-CpYJUKXc.js";
import { E as n } from "./ExternalServices-BOkwevmt.js";
function d(t) {
...
class l {
  constructor(e, a, c) {
    (this.category = e), (this.dataSource = a), (this.listElement = c);
  }
  async init() {
...
const r = i("category"),
  ...
  g = new l(r, m, u);
document.querySelector("#current-category").textContent = r;
g.init();
